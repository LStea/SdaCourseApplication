...
public abstract class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.MyViewHolder> {
        ...
        holder.checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton button, boolean isChecked) {
                ...
                if (checkListener != null) {
                    checkListener.onItemCheckStateChenged();
                }
            }
            ...
            public MyViewHolder (View itemView)extends RecyclerView.ViewHolder {
                    super(itemView);
